    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed">
          ...
          <p className="mt-4"><strong>Inactivity:</strong> if you&apos;re on the Free tier and haven&apos;t logged in for 3 months, we send you a LINE notification and schedule your account for deletion on the same 30-day timeline as a self-requested deletion. Logging in at any point before then cancels it automatically — no action needed beyond signing back in. Paying Pro and Enterprise accounts are never scheduled for deletion due to inactivity. This LINE notification comes from Shopenter&apos;s own official account, not the one connected to your store, so it reaches you even if something is wrong with your own channel.</p>
